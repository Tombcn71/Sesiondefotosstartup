        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 p-8 max-w-6xl w-full">
          <div className="flex flex-col space-y-4 lg:w-1/2 w-full">
            ...
            <p className="text-gray-600 text-xl">
              ...
              Genereer professionele zakelijke portetfoto's in HD studio
              kwaliteit die veel goedkoper zijn en geen tijd en reizen in beslag
              nemen, makkelijk vanaf thuis of je werk.
            </p>
            <div className="flex flex-col space-y-2">
              <Link href="/login">
                <Button className="border rounded-full  h-12 px-6 m-2 text-lg text-white bg-sky-600 hover:bg-sky-700 w-full lg:w-1/2">
                  Begin jouw fotosessie{" "}
                </Button>
              </Link>
            </div>
          </div>
